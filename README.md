...
Akses link, lalu gulir ke bawah, dimana terdapat icon `Desktop Layout`, lalu setelah berubah ke desktop layout, pilih icon `Full Screen` dengan begitu hasilnya dapat sesuai dengan gambar yang dilampirkan.
